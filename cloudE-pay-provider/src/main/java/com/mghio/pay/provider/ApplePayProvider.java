package com.mghio.pay.provider;

import com.mghio.dto.BaseResult;
import com.mghio.pay.redis.RedisService;
...
public class ApplePayProvider {
    ...
    public BaseResult<Boolean> applePayRecharge(@RequestParam("userId") Long userId, @RequestParam("amount") Double amount) {
